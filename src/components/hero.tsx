...
const Hero = () => {
  ...
  return (
    <HeroHighlight>
      <div className="h-[65rem] md:h-[45rem] w-full rounded-md flex-col md:flex-row flex items-center md:justify-between  antialiased  relative overflow-hidden">
        <div className=" p-4 flex flex-col items-center md:items-start justify-start   relative z-10 md:w-[70%] top-20 md:top-0 pt-20 md:pt-0">
          ...
          <div className="pt-5">
            <motion.button
              ...
              className="p-[3px] relative hidden md:flex cursor-pointer"
            >
        ...
        <motion.div
          ...
          className="rounded-b-3xl mt-20 md:mt-0 flex justify-center justify-self-center items-center md:w-1/3 rotate-6 hover:rotate-0 transition-all duration-300 cursor-pointer md:mr-20 rounded-tl-[4rem] rounded-tr-3xl border border-purple-500 overflow-hidden h-auto mx-10"
        >
          <Image
            src="/dipu.jpg"
            alt="hero"
