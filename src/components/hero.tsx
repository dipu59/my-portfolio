...
const Hero = () => {
  ...
  return (
    <HeroHighlight>
      <div className="h-[68rem] md:h-[45rem] w-full rounded-md flex-col md:flex-row flex items-center md:justify-between  antialiased  relative overflow-hidden md:pt-20">
